...
- tencent_campus.xlsx
- tencent_campus.csv
- tencent_campus_checkpoint.csv  （中途检查点）
"""
...
SOURCE_PAGE = "https://join.qq.com/post.html"
...
OUTPUT_XLSX = "tencent_campus.xlsx"
OUTPUT_CSV = "tencent_campus.csv"
CHECKPOINT_CSV = "tencent_campus_checkpoint.csv"
...
if __name__ == "__main__":
    ...
    rows = crawl_all_jobs(max_pages=1, keyword="游戏")
    save_results(rows)